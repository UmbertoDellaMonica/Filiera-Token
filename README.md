...
| ----------------- | ----------- | -------- |
| CheeseBlock (Blocco di Formaggio) | Il CheeseBlock rappresenta un'unità di formaggio prodotta e distribuita lungo la filiera. Ogni CheeseBlock è unico e identificabile attraverso il suo hash sulla blockchain di CheeseChain. | <img src="./Filiera-Token-FrontEnd/filiera_token_front_end/filiera_token_front_end/assets/cheese_block.png" alt="CheeseBlock" width="200"/> |
